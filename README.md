# Pseudo Overlapped Speckle 3D Reconstruction

[![English](https://img.shields.io/badge/Language-English-blue)](README.md)
[![简体中文](https://img.shields.io/badge/语言-简体中文-lightgrey)](README_CN.md)

A research pipeline for reconstructing 3D morphology from a single pseudo-overlapped speckle image. This repository accompanies the undergraduate thesis *A Morphology Measurement Method Based on Deep Learning Separation of Pseudo Overlapped Images*.
